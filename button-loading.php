            ...
            <div class="content">							<div class="row">
                    <div class="col-lg-6">
                      <div class="card card-default">
                        ...
                        <div class="card-body">
                          <form method="POST" id="create_centos_instance" action="create_centos_bash.php">
                            ...
                            <button class="ladda-button btn btn-success btn-square btn-ladda" data-style="zoom-in">
                              ...
                              <button type="submit" class="btn btn-primary btn-default" id="create_centos_instance">만들기</button>
